...
{:.execute_result}
    ...
    ['What’s causing #climate change, in 10 charts https://t.co/Tqb7CBnl3a via @voxdotcom',
     '#solar Links to SOLAR ELECTRIC POWER #solarfarm #solarpanels #solarpowerfarm #solaryachts #climate #change\nhttps://t.co/EvulOrZJnh',
     "It's incumbent on #policy makers, elected officials and regulators to start building in rules about #climate resili… https://t.co/ZVNZz9LvP3",
     'A #Climate Reckoning in #Fire-Stricken #California #ClimateCrisis #ClimateChange #GlobalWarming #TrumpIsKillingUS… https://t.co/bubPefPbzu',
     '@ToksDuro Hello @World, fire in #Oregun.\nPlease let us remember our brothers and sisters, children including the el… https://t.co/FQZmODL510']
...
{:.execute_result}
    ...
    ['Whats causing climate change in 10 charts via voxdotcom',
     'solar Links to SOLAR ELECTRIC POWER solarfarm solarpanels solarpowerfarm solaryachts climate change',
     'Its incumbent on policy makers elected officials and regulators to start building in rules about climate resili',
     'A Climate Reckoning in FireStricken California ClimateCrisis ClimateChange GlobalWarming TrumpIsKillingUS',
     'ToksDuro Hello World fire in OregunPlease let us remember our brothers and sisters children including the el']
...
{:.execute_result}
    ...
    ['whats', 'causing', 'climate', 'change', '10', 'charts', 'via', 'voxdotcom']
...
{:.execute_result}
    ...
    ['whats', 'causing', '10', 'charts', 'via', 'voxdotcom']
