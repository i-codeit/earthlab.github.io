...
{:.execute_result}
    ...
    (0.0, TextBlob("Whats causing climate change in 10 charts via voxdotcom"))
...
{:.execute_result}
    ...
    [0.0, 'Whats causing climate change in 10 charts via voxdotcom']
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      <th>0</th>
      <td>0.0</td>
      <td>Whats causing climate change in 10 charts via ...</td>
    </tr>
    <tr>
      <th>1</th>
      <td>0.0</td>
      <td>solar Links to SOLAR ELECTRIC POWER solarfarm ...</td>
    </tr>
    <tr>
      <th>2</th>
      <td>0.0</td>
      <td>Its incumbent on policy makers elected officia...</td>
    </tr>
    <tr>
      <th>3</th>
      <td>0.0</td>
      <td>A Climate Reckoning in FireStricken California...</td>
    </tr>
    <tr>
      <th>4</th>
      <td>0.0</td>
      <td>ToksDuro Hello World fire in OregunPlease let ...</td>
    </tr>
  </tbody>
</table>
</div>
...
{:.execute_result}
    ...
    [TextBlob("FlashbackFriday to 2018 when Patrol Sergeant Larson helped evacuate residents during the CampFire Historic wi"),
     TextBlob("DHStokyo I have so much sympathy and Im so sorry for all of you having to breathe that bad air OregonIsBurning"),
     TextBlob("davidmweissman Selfcare buddy We all need to process all of this When the CampFire in Paradise happened and"),
     TextBlob("If you havent read this extraordinary piece of writing please do Also please know that ashleygebb did reportin"),
     TextBlob("Less than 2 years ago the CampFire Californias deadliest and most destructive wildfire raged in these same and")]
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      <th>1</th>
      <td>-0.333333</td>
      <td>DHStokyo I have so much sympathy and Im so sor...</td>
    </tr>
    <tr>
      <th>3</th>
      <td>0.333333</td>
      <td>If you havent read this extraordinary piece of...</td>
    </tr>
    <tr>
      <th>4</th>
      <td>-0.066667</td>
      <td>Less than 2 years ago the CampFire Californias...</td>
    </tr>
    <tr>
      <th>5</th>
      <td>0.333333</td>
      <td>How mesmerising is watching a camp fire burn a...</td>
    </tr>
    <tr>
      <th>6</th>
      <td>-0.300000</td>
      <td>This campfire is calling your name Not too lat...</td>
    </tr>
  </tbody>
</table>
</div>
